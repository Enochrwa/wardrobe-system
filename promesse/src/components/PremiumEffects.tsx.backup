  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-0">
        ...
        {/* Center subtle glow */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[40rem] h-[40rem] bg-gradient-to-r from-yellow-400/10 via-pink-500/10 to-indigo-500/10 rounded-full blur-3xl"></div>
      </div>
